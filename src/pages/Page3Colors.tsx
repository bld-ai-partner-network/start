...
const Page3Colors: FunctionComponent = () => {
  return (
    <div className="relative bg-primary-background w-full flex flex-col items-start justify-end">
      <header className="bg-primary-main box-border w-[120rem] h-[25.09rem] overflow-hidden shrink-0 flex flex-col items-start justify-end p-[6.25rem] text-left text-[7.5rem] text-primary-contrast-text font-h1 border-b-[3px] border-solid border-grey-grey-300">
