...
const StartHeader: FunctionComponent = memo(() => {
  return (
    <header className="self-stretch bg-primary-main overflow-hidden flex flex-row items-center justify-between py-[1.56rem] px-[10rem] text-left text-[0.94rem] text-primary-contrast-text font-h1">
      <img
        className="relative w-[3.13rem] h-[3.13rem]"
        alt=""
        src="/colorwhite.svg"
      />
      <nav className="m-0 flex-1 flex flex-row items-center justify-start py-[0rem] px-[6.25rem] gap-[3.13rem] text-center text-[0.94rem] text-primary-background font-h1">
        <a
